...
px_graph_schema::px_body! { Remap, |p, i| crate::ops::remap::eval(p, &[i.field.value()]) }
...
pub fn eval(params: &params::remap::Params, inputs: &[&Field]) -> Field {
    ...
    remap_sampled(&scale, params.gamma, inputs[0])
}
