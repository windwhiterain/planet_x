...
| **T1** | ≤ 48 回合（4 年内） | `cargo nextest run` | **178 条 / 4.0 s** |
| **T2** | 49–480 回合（4–40 年） | `cargo nextest run -P mid` | 184 条 / 29.7 s |
| **T3** | > 480 回合（40 年+） | `cargo nextest run -P full`（合流门） | 189 条 / 95.8 s |
