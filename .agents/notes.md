...
- 纯搬运/拆文件类改动的行为验证：`--seed 42 --round 240 --digest 20` 的 SHA-256 必须逐字节
  ...
  **当前基线（`feature/tech-system-mond`，观测编队之后）**：`0E3E760D…9A0C` → `A5183C6A…0DC`
  → **`6E376B8F77A7558147516167a87d3f2c8eccdab3901ae15ddaf5466bfcb6573f`**
