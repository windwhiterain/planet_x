...
| `[ ]` | [运输：舰船行为 + 集货 + 信誉承包](notes/freight-collection.md) | 公理「**首都即集散地**」定下对外路线；**运输做成舰船真实行为**（`ShipBehavior::Haul` + 产地货栈，非首都产出必须靠船运回）——于是「谁可靠」由**现有 MOND 漂移**算出来：非 master 停靠上限 **30.000 AU**，够不到伊克西翁/妊神星/创神星/阋神星。承包市场以**信誉**为竞争力（信誉即准入资产 + 承运方自评闸）。 | 全部；先裁决 Q1–Q4（笔记 §8） |
