...
| `[ ]` | [集货腿与运输承包市场](notes/freight-collection.md) | 新前提「**首都即集散地**」把现有首都↔首都路线升为公理；剩下两条腿待做：**产地→首都的集货腿**（按产出流收损耗/运费，`step_production` 挂钩）与**运输承包市场**（承运人不再写死，运力来自舰级货舱、挂价簿撮合、承运人担丢货风险）。 | 全部；先裁决 D1–D8（见笔记 §7） |
