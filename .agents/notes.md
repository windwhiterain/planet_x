...
- 纯搬运/拆文件类改动的行为验证：`--seed 42 --round 240 --digest 20` 的 SHA-256 必须逐字节
  ...
  **当前基线（`feature/tech-system-mond`，B1 深空治理之后）**：`6E376B8F…573F` →
  **`7494A2C8E2F0E2E537110A5FE8D15937AE220945DFDE6C2870632369CA4BF446`**
